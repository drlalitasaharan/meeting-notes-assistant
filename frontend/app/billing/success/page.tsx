    ...
    >
      ...
      >
        ...
        <p style={{ color: "#5d6f66", fontSize: 18, lineHeight: 1.65, margin: "0 0 24px" }}>
          Thanks. If the PayPal payment was completed, MeetIQ will activate paid access
          after the verified PayPal webhook records the payment. This can take a short moment.
        </p>
